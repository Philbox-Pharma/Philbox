  ...
  <table class="container" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
      <td class="content">
        ...
        <p class="instructions">We received a request to reset your password. Click the button below to reset it.</p>
    ...
    <tr>
      <td class="footer">
        ...
        <p>&copy; <<2025>> Philbox. All rights reserved.</p>
      </td>
    </tr>
  </table>
</body>
...
export const DOCTOR_VERIFICATION_TEMPLATE = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body>
    <table class="container" cellpadding="0" cellspacing="0" border="0">
        ...
        <tr>
            <td class="content">
                <p style="font-size:16px; color:#333;"><<Hello,>></p>
                <p class="instructions">Thank you for registering as a Doctor. To activate your account and access your dashboard, please verify your email address.</p>
...
export const DOCTOR_RESET_TEMPLATE = `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body>
  <table class="container" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
      <td class="content">
        <p style="font-size:16px; color:#333;"><<Hello,>></p>
        <p class="instructions">We received a request to reset your password for your Philbox Doctor account.</p>
        <a href="<<RESET_LINK>>" class="btn">Reset Password</a>
        <p class="instructions">This link will expire in 10 minutes. If you didn’t request a password reset, please ignore this email.</p>
      </td>
    </tr>
