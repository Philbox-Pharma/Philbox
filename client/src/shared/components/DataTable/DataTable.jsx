...
export default function DataTable({
  ...
  return (
    <div className="space-y-4">
      ...
      <div
        className={`bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden ${mobileCardRender ? 'hidden md:block' : 'block'}`}
      >
                      ...
                      <input
                        ...
                        onChange={e => {
                          if (e.target.checked) {
                            ...
                            onSelectRow(
                              selectedRows.filter(id => id !== row[rowKey])
                            );
                          }
                        }}
                      />
