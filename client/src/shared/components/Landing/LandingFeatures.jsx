    ...
    const ContentSection = () => (
        ...
        >
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mt-2 mb-6">
                {title}{' '}
                <span style={{ color: primaryColor }}>{titleHighlight}</span>
            </h2>
    ...
    const ImageSection = () => (
        ...
        >
            <div
                ...
                style={{ background: theme.gradient || `linear-gradient(135deg, ${primaryColor} 0%, ${secondaryColor} 100%)` }}
            >
                {ImageIcon && <ImageIcon className="text-white/90 text-[120px] md:text-[180px]" />}
