...
export default function CustomerLanding() {
    ...
    const services = [
        { icon: FaUserMd, title: 'Online Consultations', desc: 'Connect with doctors via video call from anywhere', color: '#003399' },
        { icon: FaPills, title: 'Medicine Delivery', desc: 'Get medicines delivered to your doorstep', color: '#4FA64F' },
        { icon: FaHeartbeat, title: 'Health Monitoring', desc: 'Track your health records digitally', color: '#E74C3C' },
        { icon: FaHospital, title: 'Lab Tests', desc: 'Book lab tests with home sample collection', color: '#9B59B6' },
        { icon: FaAmbulance, title: '24/7 Emergency', desc: 'Round the clock emergency support', color: '#F39C12' },
        { icon: FaShieldAlt, title: 'Health Insurance', desc: 'Cashless treatment at partner hospitals', color: '#1ABC9C' },
    ];
    ...
    return (
        <div className="font-sans text-gray-800 overflow-x-hidden">
                ...
                <nav className="max-w-7xl mx-auto px-6 flex justify-between items-center">
                    ...
                    <div className="hidden lg:flex items-center gap-4">
                        <motion.button
                            ...
                            className={`px-6 py-2 rounded-full font-medium transition-all ${scrolled
            ...
            <section
                ...
                style={{
                    background: 'linear-gradient(135deg, #003399 0%, #0052cc 50%, #4FA64F 100%)'
                }}
            >
                ...
                <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
                    ...
                    >
                        ...
                        >
                            Connect with verified doctors, book appointments, get medicines delivered,
                        ...
                        >
                            {stats.map((stat, i) => (
                                ...
                                >
                                    <p className="text-2xl md:text-4xl font-bold text-white">{stat.number}</p>
            ...
            <section id="services" className="py-24 bg-gray-50">
                <div className="max-w-7xl mx-auto px-6">
                    <motion.div
                        ...
                        variants={fadeInUp}
                    >
                        <span className="text-[#4FA64F] font-semibold text-sm uppercase tracking-wider">Our Services</span>
                        <h2 className="text-4xl md:text-5xl font-bold text-[#003399] mt-2 mb-4">
                            Complete Healthcare Solutions
                        </h2>
                        <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                            Everything you need for your health journey, accessible from anywhere
                        </p>
                    </motion.div>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <motion.div
                            ...
                            variants={fadeInLeft}
                        >
                            <span className="text-[#003399] font-semibold text-sm uppercase tracking-wider">For Doctors</span>
                            <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mt-2 mb-6">
                                Grow Your Practice <span className="text-[#003399]">Digitally</span>
                            </h2>
                            <p className="text-gray-600 text-lg mb-8">
                                Join thousands of healthcare professionals who are expanding their reach
                                and providing better care through our platform.
                            </p>
            ...
            <section id="for-patients" className="py-24 bg-gradient-to-br from-gray-50 to-green-50 overflow-hidden">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <motion.div
                            initial="hidden"
                        ...
                        >
                            <div
                                className="w-full aspect-square max-w-lg mx-auto rounded-3xl shadow-2xl flex items-center justify-center relative overflow-hidden"
                                style={{
                                    background: 'linear-gradient(135deg, #4FA64F 0%, #2E8B57 100%)'
                                }}
                            >
                        ...
                        >
                            <span className="text-[#4FA64F] font-semibold text-sm uppercase tracking-wider">For Patients</span>
                            <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mt-2 mb-6">
                                Healthcare at Your <span className="text-[#4FA64F]">Fingertips</span>
                            </h2>
                            <p className="text-gray-600 text-lg mb-8">
                                Experience seamless healthcare from consultation to medicine delivery.
            ...
            <section id="testimonials" className="py-24 bg-white">
                <div className="max-w-7xl mx-auto px-6">
                    <motion.div
                        ...
                        variants={fadeInUp}
                    >
                        <span className="text-[#4FA64F] font-semibold text-sm uppercase tracking-wider">Testimonials</span>
                        <h2 className="text-4xl md:text-5xl font-bold text-[#003399] mt-2 mb-4">
                            What People Say
                        </h2>
                        <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                        ...
                        <div className="flex justify-center gap-3 mt-8">
                            {testimonials.map((_, i) => (
                                <button
                                    ...
                                    className={`h-3 rounded-full transition-all duration-300 ${i === activeTestimonial
                                        ? 'bg-[#003399] w-8'
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12">
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <p className="text-gray-400 mb-6 max-w-sm">
                                Pakistan's trusted digital healthcare platform connecting doctors,
                                patients, and pharmacies for better health outcomes.
                            </p>
                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                {footerLinks.company.map((link) => (
                                    <li key={link.name}>
                                        <a href={link.href} className="text-gray-400 hover:text-[#4FA64F] transition-colors">
                                            {link.name}
                                        </a>
                                    </li>
                                ))}
                    ...
                    <div className="max-w-7xl mx-auto px-6 py-6">
                        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                            <p className="text-gray-500 text-sm text-center md:text-left">
                                © 2025 <span className="text-[#4FA64F]">Philbox Pharmaceuticals</span>. All rights reserved.
                            </p>
                            <div className="flex flex-wrap justify-center gap-6 text-sm text-gray-500">
                                {footerLinks.legal.map((link) => (
                                    <a key={link.name} href={link.href} className="hover:text-[#4FA64F] transition-colors">
                                        {link.name}
                                    </a>
                                ))}
                            </div>
