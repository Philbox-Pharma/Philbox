  ...
  const [notifications, setNotifications] = useState([
    {
      ...
      title: 'Order Shipped',
      message:
        'Your order #ORD-2024-002 has been shipped. Track your package now.',
    ...
    },
    {
      ...
      message:
        'Dr. Sara Ali has sent you a new prescription. View and order medicines.',
      link: '/prescriptions',
      time: '1 day ago',
      read: false,
    ...
    },
    {
      ...
      message:
        'Your appointment with Dr. Fatima Noor has been confirmed for Jan 30.',
      link: '/appointments',
      time: '3 days ago',
      read: true,
      icon: FaCalendarCheck,
