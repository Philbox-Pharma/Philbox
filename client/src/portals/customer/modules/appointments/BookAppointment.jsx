...
export default function BookAppointment() {
    ...
    const paymentMethods = [
        { id: 'jazzcash', name: 'JazzCash', icon: FaMobileAlt, color: 'text-red-500' },
        { id: 'easypaisa', name: 'EasyPaisa', icon: FaMobileAlt, color: 'text-green-500' },
    ...
    const filteredDoctors = doctors.filter(doc => {
        ...
        const matchesType = consultationType === 'all' || doc.availableTypes.includes(consultationType);
    ...
    const handleBooking = async () => {
        ...
        setPaymentTime(new Date().toLocaleString('en-PK', {
            dateStyle: 'medium',
            timeStyle: 'short'
        }));
...
Thank you for choosing MedBox Pharmacy!
For any queries, contact us at: support@medbox.pk
...
*** This is a computer-generated receipt ***
        ...
        link.href = url;
        link.download = `MedBox_Receipt_${bookingId}.txt`;
        ...
        return (
            <div className="max-w-lg mx-auto px-4 py-16">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-500">Booking ID: <strong className="text-blue-600">{bookingId}</strong></p>
                </div>

                {/* Receipt Card */}
                <div ref={receiptRef} className="bg-white rounded-xl shadow-lg border overflow-hidden mb-6">
                    {/* Receipt Header */}
                    <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-4 text-center">
                        <h2 className="text-xl font-bold">💊 MedBox Pharmacy</h2>
                    ...
                    <div className="p-6">
                        ...
                        <div className="mt-4 pt-4 border-t-2 border-gray-200">
                            <div className="flex justify-between items-center">
                                ...
                                <span className="text-2xl font-bold text-green-600">Rs. {selectedDoctor.fee}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {selectedType === 'video' && (
                    <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6">
                        <p className="text-sm text-blue-700">
                            📹 <strong>Video Call Link</strong> will be sent to your email and will also be available in your appointments section 15 minutes before the scheduled time.
                        </p>
                    </div>
                )}
                ...
                <div className="bg-gray-50 rounded-xl p-4 mb-6">
                    <p className="text-sm text-gray-600 mb-3 text-center">Download your receipt</p>
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-8">
            ...
            <div className="mb-8">
                ...
                <h1 className="text-2xl md:text-3xl font-bold text-gray-800">Book Appointment</h1>
            ...
            <div className="flex items-center justify-center mb-8">
                {[
                    ...
                    <div key={s.num} className="flex items-center">
                        <div
                            className={`w-10 h-10 rounded-full flex items-center justify-center font-medium ${step >= s.num ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-500'
                                }`}
                        >
                        ...
                        {index < 3 && (
                            <div
                                className={`w-8 sm:w-16 h-1 mx-2 ${step > s.num ? 'bg-blue-500' : 'bg-gray-200'
                                    }`}
                            />
                        )}
                    </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                            {filteredDoctors.map((doctor) => (
                                <div
                                    ...
                                    className={`bg-white rounded-xl shadow-sm border p-4 cursor-pointer transition-all ${selectedDoctor?.id === doctor.id
                                ...
                                >
                                    <div className="flex gap-4">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="mt-3">
                                                <span className="text-lg font-bold text-gray-800">Rs. {doctor.fee}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border p-4 mb-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-medium text-blue-600">Rs. {selectedDoctor.fee}</p>
                            </div>
                            <button onClick={() => setStep(1)} className="ml-auto text-sm text-blue-600 hover:underline">
                                Change
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border p-6 mb-6">
                        ...
                        <div className="flex gap-4">
                            {selectedDoctor.availableTypes.includes('video') && (
                                <button
                                    ...
                                    className={`flex-1 flex items-center justify-center gap-2 p-4 rounded-lg border-2 transition-all ${selectedType === 'video'
                            ...
                            {selectedDoctor.availableTypes.includes('in-person') && (
                                <button
                                    ...
                                    className={`flex-1 flex items-center justify-center gap-2 p-4 rounded-lg border-2 transition-all ${selectedType === 'in-person'
                        ...
                        {selectedType === 'in-person' && (
                            <p className="text-sm text-gray-500 mt-3">📍 {selectedDoctor.hospital}</p>
                        )}
                    </div>
                        ...
                        <div className="grid grid-cols-4 sm:grid-cols-7 gap-2">
                            {availableDates.map((d) => (
                                <button
                                    ...
                                    className={`p-3 rounded-lg text-center transition-all ${selectedDate === d.date
                                ...
                                >
                                    ...
                                    <p className={`text-xs mt-1 ${selectedDate === d.date ? 'text-blue-100' : 'text-green-600'}`}>
                    ...
                    {selectedDate && (
                        <div className="bg-white rounded-xl shadow-sm border p-6 mb-6">
                            ...
                            <p className="text-sm text-gray-500 mb-4">
                                <span className="inline-block w-3 h-3 bg-gray-200 rounded mr-1"></span> Booked
                                <span className="inline-block w-3 h-3 bg-blue-500 rounded ml-4 mr-1"></span> Available
                            </p>
                            <div className="grid grid-cols-3 sm:grid-cols-5 md:grid-cols-7 gap-2">
                                {getAvailableSlots(selectedDate).map(({ time, available }) => (
                                    <button
                                        ...
                                        disabled={!available}
                                        className={`p-2 rounded-lg text-sm font-medium transition-all ${!available
                    ...
                    {/* Notes */}
                    <div className="bg-white rounded-xl shadow-sm border p-6 mb-6">
                        <h3 className="font-semibold text-gray-800 mb-2">Notes for Doctor (Optional)</h3>
                        <textarea
                            value={notes}
                ...
                <div className="max-w-2xl mx-auto">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border p-6 mb-6">
                        ...
                        <div className="flex items-center gap-4 pb-4 border-b">
                            <img src={selectedDoctor.image} alt={selectedDoctor.name} className="w-14 h-14 rounded-full" />
                            <div>
                        ...
                        <div className="py-4 space-y-2 text-sm">
                            ...
                            <div className="flex justify-between">
                                ...
                                <span className="font-medium capitalize">{selectedType === 'video' ? 'Video Call' : 'In-Person'}</span>
                            </div>
                        </div>
                        <div className="pt-4 border-t flex justify-between items-center">
                            <span className="text-lg font-semibold text-gray-800">Total Amount</span>
                            <span className="text-2xl font-bold text-blue-600">Rs. {selectedDoctor.fee}</span>
                        </div>
                    </div>
            ...
            {step === 4 && (
                <div className="max-w-2xl mx-auto">
                    <div className="bg-white rounded-xl shadow-sm border p-6 mb-6">
                        <h3 className="font-semibold text-gray-800 mb-6">Confirm Your Booking</h3>
                        ...
                        <div className="py-4 space-y-3">
                            ...
                            {selectedType === 'in-person' && (
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-medium text-gray-800 text-right">{selectedDoctor.hospital}</span>
                                </div>
                            )}
                            <div className="flex justify-between">
                            ...
                            {notes && (
                                <div className="pt-2">
                                    ...
                                    <p className="text-sm text-gray-800 bg-gray-50 p-2 rounded">{notes}</p>
                                </div>
                            )}
                        </div>
                    ...
                    <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 mb-6">
                        <p className="text-sm text-yellow-700">
                            ⚠️ By confirming, you agree to our cancellation policy. Cancellations made less than 2 hours before the appointment are non-refundable.
                        </p>
                    </div>
