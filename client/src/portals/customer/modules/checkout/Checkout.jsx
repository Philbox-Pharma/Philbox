                ...
                <div className="bg-white rounded-xl shadow-sm border p-6">
                    ...
                    <div>
                      ...
                      {existingPrescriptions.length > 0 ? (
                        <div className="space-y-2">
                          {existingPrescriptions.map(prx => (
                            <div
                              key={prx.id}
                              onClick={() =>
                                handleSelectExistingPrescription(prx)
                              }
                        ...
                        <p className="text-sm text-gray-500 italic">
                          No digital prescriptions available. Please upload a
                          prescription.
                        </p>
                      )}
                    </div>
                  ...
                  <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    <p className="text-sm text-blue-700">
                      <strong>Note:</strong> Your prescription will be verified
                      by our licensed pharmacist before your order is
                      dispatched. This usually takes 1-2 hours during business
                      hours.
                    </p>
                  </div>
                </div>
            ...
            {prescriptionRequired && (
              <div className="mt-4 p-3 bg-orange-50 rounded-lg">
                <p className="text-xs text-orange-700 flex items-start gap-2">
                  <FaFilePrescription className="mt-0.5 shrink-0" />
                  <span>
                    This order contains prescription medicines and requires a
                    valid prescription.
                  </span>
                </p>
              </div>
