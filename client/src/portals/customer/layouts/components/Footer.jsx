        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                href="https://www.facebook.com/share/1DeSgct8EE/?mibextid=wwXIfr"
              ...
              <a
                href="https://www.instagram.com/philboxofficial?igsh=MTFnZ3dyeWJzNDFvYw=="
                className="text-gray-400 hover:text-white transition-colors"
              >
                <FaInstagram size={20} />
              </a>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm">
                  Philbox Medical Complec Near Ali Town Orange Line Staion,
                  Lahore, Pakistan
                </span>
              </li>
            </ul>
