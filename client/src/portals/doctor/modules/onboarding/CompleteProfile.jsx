...
export default function CompleteProfile() {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      if (digitalSignature)
        formDataToSend.append('digital_signature', digitalSignature);
      ...
      if (
        response.data?.nextStep === 'dashboard' ||
    ...
    <div className="auth-wrapper py-8!">
      <div className="card-container w-[700px]! max-w-[95vw]!">
        ...
        <p className="auth-subtitle">
          Final step to start your practice on PhilBox
        </p>
              ...
              <div key={index} className="p-4 bg-gray-50 rounded-lg mb-3">
                ...
                <div className="grid grid-cols-2 gap-3 mb-3">
                  <input
                    ...
                    value={exp.from_year}
                    onChange={e =>
                      handleExperienceChange(index, 'from_year', e.target.value)
                    }
                    className="input-field"
                  ...
                  <input
                    ...
                    value={exp.to_year}
                    onChange={e =>
                      handleExperienceChange(index, 'to_year', e.target.value)
                    }
                    className="input-field"
                    placeholder="To Year"
                  />
