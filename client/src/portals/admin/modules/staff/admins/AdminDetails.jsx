...
import {
    FaArrowLeft, FaEdit, FaTrash, FaUserShield, FaEnvelope, FaPhone,
    FaCalendar, FaSpinner, FaCodeBranch, FaShieldAlt, FaToggleOn,
    FaToggleOff, FaKey, FaCheckCircle, FaTimesCircle
} from 'react-icons/fa';
...
export default function AdminDetails() {
    ...
    const adminPhone = admin.phone_number || admin.contactNumber || admin.phone || null;
    ...
    const adminCreatedAt = admin.created_at || admin.createdAt || new Date().toISOString();
...
<div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
    ...
    <div className="px-4 sm:px-6 pb-6 pt-14 sm:pt-16 relative">
        ...
        <div className="absolute -top-10 sm:-top-12 left-4 sm:left-6">
            <div className={`w-20 h-20 sm:w-24 sm:h-24 rounded-xl border-4 border-white shadow-lg flex items-center justify-center overflow-hidden ${
                ...
                {adminProfileImg ? (
                    ...
                    <FaUserShield className={`text-3xl sm:text-4xl ${isSuperAdmin ? 'text-purple-600' : 'text-blue-600'}`} />
                )}
            </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-6">
            <div>
                <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                    <h2 className="text-lg sm:text-xl font-bold text-gray-800">{adminName}</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            ...
            <InfoCard icon={FaPhone} label="Phone" value={adminPhone || 'Not set'} />
            <InfoCard 
                icon={FaCalendar} 
                label="Joined" 
                ...
                >
                    <h3 className="text-lg font-semibold text-gray-800 mb-4 flex items-center gap-2">
                        ...
                        <span className="ml-auto text-sm font-normal text-gray-500">
                            {adminBranches.length} {adminBranches.length === 1 ? 'branch' : 'branches'}
                        </span>
                    </h3>
                                    ...
                                    >
                                        <div className="flex items-center gap-3 min-w-0">
                                            ...
                                            <div className="min-w-0">
                                                <p className="font-medium text-gray-800 truncate">{branchName}</p>
                ...
                >
                    ...
                    <div className="mb-4 p-3 bg-gray-50 rounded-lg">
                        ...
                        <p className="font-semibold text-gray-800">
                            {typeof adminRole === 'object' ? adminRole.name : adminRole || 'No Role Assigned'}
                        </p>
                    </div>
