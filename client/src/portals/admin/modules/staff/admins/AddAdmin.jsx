...
import {
    ...
    FaLock, FaSpinner, FaCamera, FaTrash, FaEye, FaEyeSlash,
        ...
        try {
            ...
            if (response.status === 200 || response.status === 201 || response.success) {
                navigate('/admin/staff/admins', {
                    state: { message: 'Admin created successfully! Credentials sent to email.' }
                });
            } else {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-xl sm:text-2xl font-bold text-gray-800">Add New Admin</h1>
                    <p className="text-gray-600 text-sm">Create a new administrator account</p>
                </div>
            </div>
                ...
                <div className="p-4 sm:p-6 space-y-8">
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        <p className="text-blue-800 text-sm">
                            <strong>Note:</strong> An email with login credentials will be sent to the admin's email address after successful creation.
                        </p>
                    </div>
                </div>
