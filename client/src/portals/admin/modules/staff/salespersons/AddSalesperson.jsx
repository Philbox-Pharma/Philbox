...
import {
    FaArrowLeft, FaSave, FaUserTie, FaEnvelope, FaPhone,
    FaLock, FaSpinner, FaVenusMars, FaBirthdayCake,
    FaEye, FaEyeSlash, FaCodeBranch
} from 'react-icons/fa';
...
export default function AddSalesperson() {
        ...
        const fetchBranches = async () => {
            ...
            try {
                ...
                setBranchOptions([
                    ...
                    { value: '507f1f77bcf86cd799439013', label: 'Islamabad Branch (PHIL25#003)' }
                ]);
            } finally {
    ...
    const validationRules = {
        ...
        email: {
            required: true,
            pattern: /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
            message: { required: 'Email is required', pattern: 'Invalid email format' }
        },
        password: {
            required: true,
            minLength: 8,
...
const handleBranchChange = (e) => {
    ...
    setFormData(prev => ({ ...prev, branches_to_be_managed: selectedBranches }));

    if (touched.branches_to_be_managed) {
        setErrors(prev => ({
            ...prev,
            branches_to_be_managed: validateField('branches_to_be_managed', selectedBranches)
        }));
    }
};
    const handleBlur = (e) => {
        ...
        try {
            ...
            if (response.status === 200 || response.status === 201 || response.success) {
                navigate('/admin/staff/salespersons', {
                    state: { message: 'Salesperson created successfully! Credentials sent to email.' }
                });
            } else {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-gray-800">Add New Salesperson</h1>
                ...
                <div className="p-6 space-y-8">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-500 text-xs mt-1">Enter 10-15 digits without spaces or dashes</p>
                            </div>
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            {errors.branches_to_be_managed && (
                                <p className="text-red-500 text-xs mt-1">{errors.branches_to_be_managed}</p>
                            )}
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        <p className="text-blue-800 text-sm">
                            <strong>Note:</strong> An email with login credentials will be sent to the salesperson's email address after successful creation.
                        </p>
                    </div>
                </div>
