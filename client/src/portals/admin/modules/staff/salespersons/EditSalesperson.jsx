...
import {
    FaArrowLeft, FaSave, FaUserTie, FaPhone, FaSpinner,
    FaVenusMars, FaBirthdayCake, FaCodeBranch, FaExclamationTriangle
} from 'react-icons/fa';
        ...
        try {
            ...
            if (spResponse.status === 200 || spResponse.data) {
                ...
                const formValues = {
                    ...
                    branches_to_be_managed: person.branches_to_be_managed?.map(b => b._id) || []
                };
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-xl sm:text-2xl font-bold text-gray-800">Edit Salesperson</h1>
                    <p className="text-gray-600 text-sm mt-1">Update salesperson information</p>
                </div>
            </div>
                ...
                <div className="p-4 sm:p-6 space-y-6">
                    ...
                    {originalData?.email && (
                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                            <p className="text-sm text-gray-500 mb-1">Email Address (cannot be changed)</p>
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        <p className="text-blue-800 text-sm">
                            <strong>Note:</strong> To change account status (suspend/block), go to the salesperson's detail page and use the status buttons.
                        </p>
                    </div>
                </div>
