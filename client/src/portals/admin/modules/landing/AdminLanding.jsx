...
export default function AdminLanding() {
    ...
    const heroContent = {
        ...
        description: 'Manage your entire pharmacy network from one powerful dashboard. Monitor branches, staff, inventory, and analytics with enterprise-grade security.',
        primaryCTA: {
    ...
    // Social Links
    const socialLinks = [
        { name: 'LinkedIn', href: 'https://linkedin.com/company/philbox', icon: 'linkedin' },
    ];
