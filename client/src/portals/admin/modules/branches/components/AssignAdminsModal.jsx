...
export default function AssignAdminsModal({
    ...
    const fetchAdmins = async () => {
        ...
        try {
            ...
            // Mock data for now
            setAdmins([
                { _id: '1', name: 'Admin One', email: 'admin1@philbox.com', admin_category: 'super_admin' },
                { _id: '2', name: 'Admin Two', email: 'admin2@philbox.com', admin_category: 'branch_admin' },
                { _id: '3', name: 'Admin Three', email: 'admin3@philbox.com', admin_category: 'branch_admin' },
            ]);
        } finally {
            setLoading(false);
        }
                                        ...
                                        {admins.map((admin) => (
                                            ...
                                            >
                                                ...
                                                <div className="flex-1">
                                                    <p className="font-medium text-gray-800">{admin.name || admin.fullName}</p>
                                                ...
                                                <span className={`text-xs px-2 py-1 rounded-full ${
                                                    ...
                                                    {admin.admin_category === 'super_admin' ? 'Super Admin' : 'Branch Admin'}
                                                </span>
                                            </div>
                                        ))}
                                    </div>
                                ) : (
                                    <p className="text-gray-500 text-center py-8">No admins available</p>
                                )}
                            </div>
