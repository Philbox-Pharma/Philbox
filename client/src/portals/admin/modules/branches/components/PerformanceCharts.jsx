    ...
    if (chartData.length === 0) {
        return (
            <div className="bg-white p-12 rounded-xl shadow-md border border-gray-100 text-center mt-6">
                <p className="text-gray-500">No daily data available from backend for graphs.</p>
            </div>
        );
    }
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                ...
                <div className="h-72">
                    <ResponsiveContainer width="100%" height="100%">
                        <AreaChart data={chartData}>
                            ...
                            <Tooltip formatter={(val) => [`Rs. ${val.toLocaleString()}`, 'Revenue']} />
            ...
            <motion.div
                ...
                className="bg-white p-6 rounded-xl shadow-md border border-gray-100"
            >
                <h3 className="text-lg font-semibold text-gray-800 mb-6">Orders Volume</h3>
                <div className="h-72">
                    <ResponsiveContainer width="100%" height="100%">
