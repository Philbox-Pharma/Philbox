    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.success || response.status === 200 || response.status === 201) {
                navigate('/admin/branches', { state: { message: 'Branch created successfully!' } });
            } else {
        ...
        <div className="space-y-6">
            ...
            <motion.form initial={{ opacity: 0 }} animate={{ opacity: 1 }} onSubmit={handleSubmit} className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                ...
                <div className="p-6 space-y-8">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <FormInput label="Phone Number" name="phone" value={formData.phone} onChange={handleChange} onBlur={handleBlur} error={errors.phone} icon={FaPhone} placeholder="+92-300-1234567" />
                        </div>
                    </div>
                ...
                <div className="px-6 py-4 bg-gray-50 border-t flex justify-end gap-3">
                    ...
                    <button type="submit" disabled={loading} className="px-6 py-2 bg-[#1a365d] text-white rounded-lg hover:bg-[#2c5282] flex items-center gap-2">
                        {loading ? <FaSpinner className="animate-spin" /> : <><FaSave /> Create Branch</>}
                    </button>
                </div>
            </motion.form>
